...
import com.tg.java.common.ParameterMetaData;
import com.tg.java.common.PreparedStatement;
...
public class RestppPreparedStatement extends PreparedStatement {
  ...
  private static final Logger logger = LoggerFactory.getLogger(RestppPreparedStatement.class);
