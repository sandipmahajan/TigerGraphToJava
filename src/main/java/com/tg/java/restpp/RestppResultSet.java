...
import com.tg.java.common.Attribute;
import com.tg.java.common.ResultSet;
import com.tg.java.common.ResultSetMetaData;
import com.tg.java.common.Statement;
import com.tg.java.common.TableResults;
...
public class RestppResultSet extends ResultSet {
  ...
  private static final Logger logger = LoggerFactory.getLogger(RestppResultSet.class);
